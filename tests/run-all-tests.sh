...
pass=0; fail=0
for t in test-quota.js verify-toggle.js verify-bonus-real.js verify-extra.js verify-extra-bonuses.js verify-grace-extension.js verify-creator-sees-pay.js; do
  name=$(basename "$t" .js)
