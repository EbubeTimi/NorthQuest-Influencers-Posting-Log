...
pass=0; fail=0
for t in test-quota.js verify-toggle.js verify-bonus-real.js verify-extra.js verify-extra-bonuses.js verify-grace-extension.js verify-false-alarms.js verify-creator-inconsistencies.js verify-creator-sees-pay.js verify-loadfail-and-credit.js verify-windowed-log.js; do
  name=$(basename "$t" .js)
