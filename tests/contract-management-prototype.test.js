...
test('makes each creator selection row fully tappable',()=>{assert.match(html,/<label class="check" for="amara">/);assert.match(html,/<label class="check" for="selectAffected">/);assert.match(html,/\.check\{[^}]*cursor:pointer/);});
