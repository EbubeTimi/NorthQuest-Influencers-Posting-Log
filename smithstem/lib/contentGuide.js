...
// Creator_Guide.docx, NQ_Trial_Creator_Guide_Revised.docx) — only the parts
// that actually help someone decide what to film: the content formats and
// the one piece of house style. Account setup, saved-detail tables, and
// creator passwords stay out of the app entirely (the last of those was an
// explicit no from an earlier pass this session).
