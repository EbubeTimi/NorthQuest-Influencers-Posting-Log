        ...
        {state.phase === "ready" && (
          <div className="space-y-4">
            <div className="card space-y-3">
              ...
              <p className="text-base text-muted">Post short-form video on your own TikTok and Instagram — your face, your style, your account. No experience needed, just a phone camera and consistency.</p>
            ...
            <form onSubmit={submit} className="card space-y-3">
              ...
              <input className="input" type="tel" placeholder="Phone (optional)" value={form.phone} onChange={(e) => setForm((f) => ({ ...f, phone: e.target.value }))} />
